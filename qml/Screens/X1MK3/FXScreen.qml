    ...
    switch (fxSectionLayer)
    {
      ...
      case FXSectionLayer.mixer:
      {
        ...
        switch(knob) {
          ...
          case 4: return ((!browseShiftPushAction && !shift) || (browseShiftPushAction && shift)) ? "VOL" : "GAIN";
        }
        break;
      }
    }
    ...
    switch (fxSectionLayer)
    {
      ...
      case FXSectionLayer.mixer:
      {
        ...
        switch(knob) {
          ...
          case 2: return (200.0 * deckEqLow.value  - 100.0).toFixed();
          case 3: return (200.0 * deckFXAdjust.value  - 100.0).toFixed();
          case 4: return ((!browseShiftPushAction && !shift) || (browseShiftPushAction && shift)) ? (100.0 * deckVolume.value).toFixed() : (200.0 * deckGain.value - 100.0).toFixed();
        }

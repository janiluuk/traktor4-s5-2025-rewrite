...
//--------------------------------------------------------------------------------------------------------------------
  ...
  readonly property int topLeftState: customHeader.topLeftState
  readonly property int topMiddleState:	customHeader.topMiddleState
  readonly property int topRightState: customHeader.topRightState

  readonly property int midLeftState: customHeader.midLeftState
  readonly property int midMiddleState: customHeader.midMiddleState
  readonly property int midRightState: customHeader.midRightState

  readonly property int bottomLeftState: customHeader.bottomLeftState
  readonly property int bottomMiddleState: customHeader.bottomMiddleState
  readonly property int bottomRightState: customHeader.bottomRightState

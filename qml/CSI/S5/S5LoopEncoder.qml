/*
 * Module: CSI/S5/S5LoopEncoder.qml
...
*/
            ...
            WiresGroup {
                ...
                Wire { from: "%surface%.encoder.turn"; to: EncoderScriptAdapter { onIncrement: {beatsXscan.value = 4; scan.value = !scan.value} onDecrement: {beatsXscan.value = -4; scan.value = !scan.value} } enabled: encoderScanMode.value }

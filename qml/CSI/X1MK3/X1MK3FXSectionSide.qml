...
Module
{
  ...
  WiresGroup
  {
    ...
    Wire { from: "softtakeover2.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.1.eq.low";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: (!shift && !browseShiftPushActionProp.value) || (shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.1.volume";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { enabled: (shift && !browseShiftPushActionProp.value) || (!shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.1.gain";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: shift; from: "%surface%.buttons.1"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.1.eq.kill_mid";  color: Color.Blue } }
    Wire { from: "%surface%.buttons.2"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.1.eq.kill_low";  color: Color.Blue } }
  ...
  WiresGroup
  {
    ...
    Wire { from: "softtakeover2.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.2.eq.low";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: (!shift && !browseShiftPushActionProp.value) || (shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.2.volume";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { enabled: (shift && !browseShiftPushActionProp.value) || (!shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.2.gain";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: shift; from: "%surface%.buttons.1"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.2.eq.kill_mid";  color: Color.Blue } }
    Wire { from: "%surface%.buttons.2"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.2.eq.kill_low";  color: Color.Blue } }
  ...
  WiresGroup
  {
    ...
    Wire { from: "softtakeover2.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.3.eq.low";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: (!shift && !browseShiftPushActionProp.value) || (shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.3.volume";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { enabled: (shift && !browseShiftPushActionProp.value) || (!shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.3.gain";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: shift; from: "%surface%.buttons.1"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.3.eq.kill_mid";  color: Color.Blue } }
    Wire { from: "%surface%.buttons.2"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.3.eq.kill_low";  color: Color.Blue } }
  ...
  WiresGroup
  {
    ...
    Wire { from: "softtakeover2.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.4.eq.low";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: (!shift && !browseShiftPushActionProp.value) || (shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.4.volume";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { enabled: (shift && !browseShiftPushActionProp.value) || (!shift && browseShiftPushActionProp.value); from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels.4.gain";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    ...
    Wire { enabled: shift; from: "%surface%.buttons.1"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.4.eq.kill_mid";  color: Color.Blue } }
    Wire { from: "%surface%.buttons.2"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels.4.eq.kill_low";  color: Color.Blue } }
